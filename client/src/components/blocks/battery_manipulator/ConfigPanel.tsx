    ...
    <div className="space-y-3">
      ...
      <div className="space-y-1">
        ...
        <Input
          ...
          placeholder="bateria_manipulador"
      ...
      <div className="space-y-1">
        ...
        <Input
          ...
          placeholder="Bateria manipulador"
          className="h-8"
        />
      </div>
      ...
      <p className="text-xs text-muted-foreground leading-relaxed">
        Seleccion de bateria para la unidad mecanica del catalogo de consumibles.
        Muestra baterias compatibles con manipulador (mechanical_unit).
      </p>
    </div>
  );
}
