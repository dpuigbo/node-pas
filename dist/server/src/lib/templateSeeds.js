...
exports.getMechanicalUnitTemplate = getMechanicalUnitTemplate;
exports.getControllerTemplate = getControllerTemplate;
exports.getDriveUnitTemplate = getDriveUnitTemplate;
exports.getExternalAxisTemplate = getExternalAxisTemplate;
...
// ============================================================
function getMechanicalUnitTemplate() {
    return {
        blocks: [
...
// ============================================================
function getExternalAxisTemplate() {
    return {
        blocks: [
            block('section_title', {
...
//# sourceMappingURL=templateSeeds.js.map