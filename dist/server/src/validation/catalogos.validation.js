...
exports.createConsumibleSchema = zod_1.z.object({
    ...
    refOriginal: zod_1.z.string().max(200).optional().nullable(),
    refProveedor: zod_1.z.string().max(200).optional().nullable(),
    denominacion: zod_1.z.string().max(200).optional().nullable(),
    fabricanteRobot: zod_1.z.string().max(200).optional().nullable(),
    coste: zod_1.z.number().positive().optional().nullable(),
    precio: zod_1.z.number().positive().optional().nullable(),
    activo: zod_1.z.boolean().optional().default(true),
});
